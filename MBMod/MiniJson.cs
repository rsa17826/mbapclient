...
public static class Json
{
    ...
    private sealed class Parser : IDisposable
    {
        ...
        private object ParseNumber()
        {
            ...
            {
                long longVal;
                if (long.TryParse(number, out longVal)) return longVal;
            }

            double doubleVal;
            double.TryParse(number, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out doubleVal);
            return doubleVal;
        }
